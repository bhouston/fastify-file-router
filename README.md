...
See [CONTRIBUTING.md](CONTRIBUTING.md) for the issue → branch → PR workflow, [RELEASING.md](RELEASING.md) for release setup, [GitHub Releases](https://github.com/bhouston/fastify-file-router/releases) for changes, and [SECURITY.md](SECURITY.md) for private vulnerability reporting.
